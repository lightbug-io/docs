<template>
    <div>
        ...
        <div class="controls-import">
            ...
            <div style="display: flex; gap: 10px;">
                <v-btn @click="importFromText">Render
                </v-btn>
        ...
        <div class="controls-bottom">
            <v-btn @click="clearCanvas" density="compact">Clear</v-btn>
            <v-slider v-model="brushSize" label="Brush Size" min="5" max="500" density="compact"></v-slider>
        </div>
        <h4>Export</h4>
        <span>Takes the rendering in the canvas above, and outputs it as a C array</span>
        <div style="display: flex; gap: 10px;">
            <v-text-field v-model.number="exportSizeX" label="X Size" type="number" density="compact" readonly></v-text-field>
            <v-text-field v-model.number="exportSizeY" label="Y Size" type="number" density="compact" readonly></v-text-field>
        </div>
        <div style="display: flex; gap: 10px;">
            <v-text-field v-model.number="exportPositionX" label="X Position" type="number" density="compact" readonly></v-text-field>
            <v-text-field v-model.number="exportPositionY" label="Y Position" type="number" density="compact" readonly></v-text-field>
        </div>
        <v-btn @click="exportBitmap" density="compact">Export Bitmap</v-btn>
        <v-textarea v-model="cArrayOutput" label="C array" outlined density="compact" readonly></v-textarea>
    </div>
</template>
...
export default {
    data() {
        return {
            ...
            isDrawing: false,
            ctx: null,
            cArrayInput: `A Lightbug logo 40 by 40... 0X00,0X00,0X00,0X00,0X00,0X03,0XFF,0XFF,0XFF,0XC0,0X0F,0XFF,0XFF,0XFF,0XF0,0X1F,0XFF,0XFF,0XFF,0XF8,0X3F,0XFF,0XFF,0XFF,0XFC,0X7F,0XFF,0XFF,0XFF,0XFC,0X7F,0XFF,0XFF,0XFF,0XFE,0X7F,0XFF,0XFF,0XFF,0XFE,0X7F,0XFF,0XFF,0XFF,0XFE,0X7F,0XFF,0X00,0XFF,0XFE,0X7F,0XFC,0X00,0X3F,0XFE,0X7F,0XFC,0X00,0X3F,0XFE,0X7F,0XFF,0XE7,0XFF,0XFE,0X7F,0XFF,0XFF,0XFF,0XFE,0X7F,0XFC,0X18,0X3F,0XFE,0X7F,0XFC,0X18,0X3F,0XFE,0X7F,0XFC,0X18,0X3F,0XFE,0X7F,0XFC,0X18,0X3F,0XFE,0X7F,0XFC,0X18,0X3F,0XFE,0X7F,0XFC,0X18,0X3F,0XFE,0X7F,0XFC,0X18,0X3F,0XFE,0X7F,0XFC,0X18,0X3F,0XFE,0X7F,0XFC,0X18,0X3F,0XFE,0X7F,0XFC,0X18,0X3F,0XFE,0X7F,0XFC,0X18,0X3F,0XFE,0X7F,0XFC,0X18,0X3F,0XFE,0X7F,0XFF,0XFF,0XFF,0XFE,0X7F,0XFF,0XFF,0XFF,0XFE,0X7F,0XFF,0XFF,0XFF,0XFE,0X3F,0XFF,0XFF,0XFF,0XFC,0X3F,0XFF,0XFF,0XFF,0XFC,0X1F,0XFF,0XFF,0XFF,0XF8,0X0F,0XFF,0XFF,0XFF,0XF0,0X03,0XFF,0XFF,0XFF,0XC0,0X00,0X00,0X00,0X00,0X00`,
            importWidth: 40,
            importHeight: 40,
            importX: 0,
            importY: 0,
    ...
    let minX = canvasWidth, minY = canvasHeight, maxX = -1, maxY = -1;
    ...
    if (maxX === -1) {
        this.exportSizeX = 0;
        this.exportSizeY = 0;
        this.exportPositionX = 0;
        this.exportPositionY = 0;
        this.cArrayOutput = '';
        return;
    }
    ...
    this.exportPositionX = gridX;
    this.exportPositionY = gridY;
    this.exportSizeX = gridWidth;
    this.exportSizeY = gridHeight;
    ...
    // Pack each row of the binary grid into bytes (8 pixels per byte).
    const cArray = [];
    ...
    // Join the C array values with commas.
    this.cArrayOutput = cArray.join(',');
}
