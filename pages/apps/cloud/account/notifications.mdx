...
Within the `Message` key, you will find the notification data.
 ...
 - `notification` contains the [notification data, as documented in the V1 API](https://docs.lightbug.io/apis/v1#?route=cmp--schemas-notification).
 - `datapoint` contains the [datapoint data, as documented in the V1 API](https://docs.lightbug.io/apis/v1#?route=cmp--schemas-datapoint) for the datapoint that triggered the notification.
