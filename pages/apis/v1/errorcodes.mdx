...
- 32: GSM no network
- 33: GSM denied
- 34: **GPS lock fail**: Indicates that the device failed to acquire a GPS lock within the [GPS timeout period](/devices/configuration/sensors#gps-timeout).
